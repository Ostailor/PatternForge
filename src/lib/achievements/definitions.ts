...
export const achievementDefinitions: AchievementDefinition[] = [
  ...
  {
    key: "first-spoken-forge",
    name: "First Spoken Forge",
  ...
  },
  {
    ...
    description: "Score 85 or higher for spoken clarity.",
    icon: "CE",
    xpReward: 100,
  },
  {
    key: "structured-thinker",
    name: "Structured Thinker",
    description: "Score 85 or higher for spoken structure.",
    icon: "ST",
    xpReward: 100,
  },
  {
    key: "pattern-narrator",
    name: "Pattern Narrator",
    description: "Score 85 or higher for technical explanation.",
    icon: "PN",
    xpReward: 100,
  },
  {
    key: "complexity-speaker",
    name: "Complexity Speaker",
    description: "Complete 5 complexity narration drills.",
    icon: "CS",
    xpReward: 100,
  },
];
